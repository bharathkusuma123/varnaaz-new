...
const SuperAdminDailyAttendance = () => {
  ...
  const fetchAttendanceData = async () => {
    try {
      setLoading(true);
      const attendanceRef = collection(db, 'sa_attendance');
            ...
            <table className="attendance-table">
              ...
              <tbody>
                {paginatedData.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="7" className="no-data">No attendance records found for this date</td>
                  </tr>
                )}
              </tbody>
            </table>
...
export default SuperAdminDailyAttendance;
