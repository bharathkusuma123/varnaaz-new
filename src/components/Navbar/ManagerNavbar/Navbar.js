      ...
      <div className="navbar-container">
        ...
        <div className={`nav-menu ${isMobile ? 'active' : ''}`}>
          ...
          <div className="nav-item dropdown">
            ...
            <div className="dropdown-menu">
              <NavLink to="/m-taskmanager" className="dropdown-item" onClick={() => setIsMobile(false)}>
                 Task Manager
              </NavLink>
              <NavLink to="/m-mytaskmanager" className="dropdown-item" onClick={() => setIsMobile(false)}>
                My Tasks
              </NavLink>
            </div>
          </div>
          {/* <NavLink to="/m-taskmanager" className="nav-item" onClick={() => setIsMobile(false)}>
            Task Manager
          </NavLink> */}
